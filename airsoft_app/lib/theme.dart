...
class AppTheme {
  ...
  static ThemeData lightTheme = ThemeData(
      ...
      textTheme: TextTheme(bodyText1: TextStyle(color: blackColor)),
      iconTheme: IconThemeData(color: iconColor),
      bottomAppBarColor: whiteColor,
      dividerColor: lightGrey,
      primaryTextTheme:
          const TextTheme(bodyText1: TextStyle(color: titleTextColor)));

  static TextStyle titleStyle =
      const TextStyle(color: titleTextColor, fontSize: 16);
